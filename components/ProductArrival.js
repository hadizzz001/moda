                        ...
                        <>
                            ...
                            <div className="  ProductTile-SliderContainer ProductTile-SliderContainer--YMAL px-3" data-product-list-category="ymal-slider">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <h1 className="mb-10 py-2 leading-[0rem] font-stretch-[66.66%] not-italic tracking-widest   text-[#222] transition text-nowrap font-bold text-[18px] myGray">
                                        Featured Products
                                    </h1> 
                                </div> 
                                {allTemps.length > 0 ? (
