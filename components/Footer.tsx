            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            {/* <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@milanomoda"
                                    data-auto-id="true"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/milanomoda.ae/"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/Milanomoda.ae/"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} milanomoda
                                </span>
                            </div>
                        </div>
                    </div>
               ...
               <div className="NewsletterSignupFooter mb-20">
