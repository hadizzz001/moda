                ...
                <section className="ProductSelector">
                  <span className="ProvidersSingleProduct--selected">
                    ...
                    {hasSizes ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <h6 className="mb-2 myGray  font-bold text-lg">${parseFloat(price).toFixed(2)}</h6>
                      </div>
                    )}
                    <span className="ProvidersIfSelectedProductMatchesFilter">
                      <p
                              ...
                              {availableColorsWithSizes
                                ...
                                ?.map((s, idx) => (
                                  <button
                                    ...
                                    className={`px-3 py-1 m-1 border rounded ${selectedSize === s.size ? 'bg-[#dbc0d3] text-white' : 'bg-gray-100'
                                      } myGray`}
                                  >
                                    {s.size}
                                  </button>
